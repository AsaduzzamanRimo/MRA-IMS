class MemberManagementPage {
    ...
    navigateToMemberList() {
      ...
      cy.wait(3000);
      cy.get('#member > .mat-list-item-content').click();
      cy.wait(9000);
    }
    ...
    searchForMember(memberName) {
      cy.get('#btnSearch').type(memberName);
      cy.wait(5000);
    ...
    createMember(officeId, samityId, memberNameEnglish, dateOfBirth, 
        identificationType, passportNo, firstMobileNumber,
        fatherNameEnglish, motherNameEnglish, divisionName,
      ...
      cy.get('#samityId > .ng-select-container').click();
      cy.get('.ng-option-label').contains(samityId).click();
      cy.get('#memberNameEn').type(memberNameEnglish);
    ...
    approveMember(){
      ...
      cy.get('#my-task-member > .mat-list-item-content').click();
      cy.wait(7000);
      cy.get('#actionbtn_40 > .mat-button-wrapper > .ng-star-inserted').click();
      cy.wait(9000);
    ...
    updateMember(resAddressLineTwo){
        cy.get('#actionbtn_60 > .mat-button-wrapper > .ng-star-inserted').click();
        cy.wait(6000);
        cy.get('#mat-tab-label-2-2 > .mat-tab-label-content').click(); 
