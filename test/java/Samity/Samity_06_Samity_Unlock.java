...
public class Samity_06_Samity_Unlock extends baseDriver {
...
driver.findElement(By.xpath("//img[@id='unlockButtonImg_2']")).click();
Thread.sleep(2000);

driver.findElement(By.xpath("//body/app-root[1]/app-main-shell[1]/app-navbar[1]/mat-sidenav-container[1]/mat-sidenav-content[1]/div[1]/app-mfi-app[1]/div[1]/app-mfi-samity[1]/app-mfi-samity-list[1]/div[2]/div[1]/app-data-table-workflow[1]/app-confirmation-modal[1]/div[1]/div[1]/div[1]/div[3]/button[1]")).click();
Thread.sleep(2000);
}
}
